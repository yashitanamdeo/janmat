            ...
            if (action === 'assign' && selectedOfficer) {
                ...
                await Promise.all(
                    selectedComplaintIds.map(id =>
                        axios.post(`http://localhost:3000/api/admin/complaints/${id}/assign`,
                ...
                await Promise.all(
                    selectedComplaintIds.map(id =>
                        axios.patch(`http://localhost:3000/api/complaints/${id}/status`,
                ...
                await Promise.all(
                    selectedComplaintIds.map(id =>
                        axios.patch(`http://localhost:3000/api/admin/complaints/${id}/department`,
