                    ...
                    {loading ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {officers.map((officer, index) => (
                                <div
                                    key={officer.id}
                                    className="p-5 rounded-xl border-2 transition-all hover:shadow-lg hover:scale-105 cursor-pointer"
                                    style={{
                                ...
                                >
                                    <div className="flex items-start gap-4">
                                        <div className="w-14 h-14 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white font-bold text-xl shadow-lg flex-shrink-0">
