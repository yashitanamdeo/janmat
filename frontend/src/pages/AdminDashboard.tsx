...
export const AdminDashboard: React.FC = () => {
    ...
    const loadData = async () => {
        ...
        try {
            // Fetch complaints
            const complaintsRes = await axios.get('https://janmat-backend-r51g.onrender.com/api/admin/complaints', { headers });
        ...
        try {
            const [trendsRes, perfRes, officersRes, departmentsRes] = await Promise.allSettled([
                axios.get('https://janmat-backend-r51g.onrender.com/api/analytics/trends', { headers }),
                axios.get('https://janmat-backend-r51g.onrender.com/api/analytics/department-performance', { headers }),
                axios.get('https://janmat-backend-r51g.onrender.com/api/admin/officers', { headers }),
                axios.get('https://janmat-backend-r51g.onrender.com/api/admin/departments', { headers })
            ]);
    ...
    const handleExport = async (format: 'csv' | 'pdf') => {
        try {
            const token = localStorage.getItem('token');
            const response = await axios.get(`https://janmat-backend-r51g.onrender.com/api/admin/reports?format=${format}`, {
