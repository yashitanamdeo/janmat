    ...
    useEffect(() => {
        const loadComplaints = async () => {
            ...
            try {
                ...
                const response = await axios.get('https://janmat-backend-r51g.onrender.com/api/complaints/my-complaints', {
        ...
        <div className="min-h-screen" style={{ background: 'var(--bg-primary)' }}>
            ...
            <EnhancedComplaintDetailsModal
                ...
                onUpdate={() => {
                    ...
                    const token = localStorage.getItem('token');
                    axios.get('https://janmat-backend-r51g.onrender.com/api/complaints/my-complaints', {
                        headers: { Authorization: `Bearer ${token}` },
                    }).then(response => {
                        dispatch(fetchComplaintsSuccess(response.data));
                    });
